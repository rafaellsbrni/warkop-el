        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <main class="flex-1 overflow-y-auto px-8 py-7">
                <?php if(session('success')): ?>
                    <div class="mb-6 flex items-center gap-2 px-4 py-3 rounded-lg bg-green-500/15 border border-green-500/30 text-green-400 text-sm">
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M9 12l2 2 4-4"/></svg>
...
<?php /**PATH C:\Users\verrell\warkop-el\resources\views/layouts/app.blade.php ENDPATH**/ ?>