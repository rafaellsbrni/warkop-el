    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-5xl">
        ...
        <div class="lg:col-span-1 rounded-xl bg-wk-panel border border-wk-border p-7 flex flex-col items-center text-center">
            <div class="w-24 h-24 rounded-full bg-wk-panel2 border-2 border-wk-orange flex items-center justify-center text-3xl font-bold text-wk-orange mb-4">
                <?php echo e(strtoupper(substr($profil['nama'], 0, 1))); ?>

            </div>
            <p class="text-lg font-semibold text-white"><?php echo e($profil['nama']); ?></p>
            <span class="mt-2 inline-block px-3 py-1 rounded-md text-xs font-semibold bg-red-500 text-white"><?php echo e($profil['role']); ?></span>
        ...
        <div class="lg:col-span-2 rounded-xl bg-wk-panel border border-wk-border p-7">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" value="<?php echo e($profil['username']); ?>" readonly
                ...
                <div>
                    ...
                    <input type="text" value="<?php echo e($profil['email']); ?>" readonly
                        class="w-full rounded-lg bg-wk-panel2 border border-wk-border text-gray-200 px-4 py-2.5 focus:outline-none">
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm text-gray-400 mb-1.5">No. HP</label>
                        <input type="text" value="<?php echo e($profil['no_hp']); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" value="<?php echo e($profil['bergabung']); ?>" readonly
                            class="w-full rounded-lg bg-wk-panel2 border border-wk-border text-gray-200 px-4 py-2.5 focus:outline-none">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Treemas\Kuliah\warkop-el\resources\views/profil/index.blade.php ENDPATH**/ ?>