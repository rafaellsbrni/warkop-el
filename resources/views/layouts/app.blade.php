...
<head>
    ...
    <title>@yield('title', 'Warkop') — Warkop EL</title>
    ...
    <div class="min-h-screen flex bg-wk-bg">
        ...
        <aside class="w-64 shrink-0 bg-wk-sidebar border-r border-wk-orange/40 flex flex-col">
            <div class="h-20 flex items-center gap-3 px-6 border-b border-wk-orange/20">
                <img src="{{ asset('images/logo_warkop.png') }}" alt="Logo Warkop EL" class="w-14 h-14 object-contain">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1">
                ...
                @foreach ($menu as $item)
                    <a href="{{ route($item['route']) }}"
                       class="nav-link {{ $item['active'] ? 'active' : '' }} group flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-gray-300 hover:text-wk-orange-light hover:bg-wk-orange/5 transition">
